(function (root, factory) {
  ...
  HeaderBarState.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'HeaderBarState',
    interfaces: []
  };
  ...
  Object.defineProperty(HeaderBarStyles.prototype, 'textContainer', {
    configurable: true,
    get: function () {
  ...
  HeaderBarStyles.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'HeaderBarStyles',
    interfaces: [StyleSheet]
  };
  ...
  Object.defineProperty(package$headerbar, 'HeaderBarStyles', {
    get: HeaderBarStyles_getInstance
  });
  ...
  _.Welcome = Welcome;
  main();
  Kotlin.defineModule('todo-app', _);
  return _;
}));
